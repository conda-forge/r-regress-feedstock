...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-regress-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-regress-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-regress-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-regress-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-regress-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-regress-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-regress/badges/version.svg)](https://anaconda.org/conda-forge/r-regress)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-regress/badges/downloads.svg)](https://anaconda.org/conda-forge/r-regress)
